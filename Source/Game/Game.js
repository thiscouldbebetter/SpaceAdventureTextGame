...
class Items {
    ...
    gasGrenade() {
        ...
        ].join("")).scriptGetSet(Script.fromName(Scripts.Instance().itemGasGrenadeGet.name)).commandAdd(Command.fromTextsAndScriptExecuteName(MessageHelper.combinePhraseArrays([
            ["throw", "drop", "use"],
            [null, "gas"],
            ["grenade"]
...
class Places {
    ...
    friendlyShipBridge() {
        return this.place3(Places.friendlyShipBridge_Name(), [
            ...
            this.portal(["door", "outside", "hall", "corridor", "aft"], Places.friendlyShipUpperDeckHallForward_Name()),
            this.emplacement2(["captain", "captain's body"], [
                "The captain still looks calm and self-assured, even with a ",
                "ten-centimeter hole blasted through her midsection.  ",
                "What a class act."
            ].join("")).commandAdd(Command.fromTextsAndScriptExecuteName(["search captain", "search captain's body"], this.scripts.emplacementCaptainsBodyKeycardSearch.name)).commandAdd(Command.fromTextsAndScriptExecuteName(["search body"], this.scripts.placeFriendlyShipBridge_SearchBody.name)),
            ...
            ].join("")).commandAdd(Command.fromTextsAndScriptExecuteName(["sit in chair"], this.scripts.placeFriendlyShipBridge_SitInChair.name)).commandAdd(Command.fromTextsAndScriptExecuteName(["hide behind captain's chair", "hide behind chair"], this.scripts.placeFriendlyShipBridge_HideBehindCaptainsChair.name)).scriptUpdateForTurnSet(Script.fromName(this.scripts.placeFriendlyShip_CheckIfPlayerIsStillHidden.name)),
            this.emplacement2(["counselor", "counselor's body"], [
            ...
            ].join("")).commandAdd(Command.fromTextsAndScriptExecuteName(["search counselor", "search counselor's body"], this.scripts.emplacementBodyEmptySearch.name)),
            this.emplacement2(["first officer", "first officer's body"], [
            ...
            ].join("")).commandAdd(Command.fromTextsAndScriptExecuteName(["search first officer", "search first officer's body"], this.scripts.emplacementBodyEmptySearch.name)),
            this.emplacement2(["helmsman", "helmsman's body"], [
                "The helmsman hit on you one time.  ",
                "Honestly, you were flattered: He kept it tight."
            ].join("")).commandAdd(Command.fromTextsAndScriptExecuteName(["search helmsman", "search helmsman's body"], this.scripts.emplacementBodyEmptySearch.name)),
            this.emplacement2(["navigator", "navigator's body"], "You never understood anything this kid said.  Plus his accent seemed fakey.").commandAdd(Command.fromTextsAndScriptExecuteName(["search navigator", "search navigator's body"], this.scripts.emplacementBodyEmptySearch.name)),
            this.emplacement2(["tactical officer", "tactical officer's body"], [
            ...
            ].join("")).commandAdd(Command.fromTextsAndScriptExecuteName(["search tactical officer", "search tactical officer's body"], this.scripts.emplacementBodyEmptySearch.name))
        ]);
    }
    ...
    friendlyShipCaptainsQuarters() {
        return this.place3(Places.friendlyShipCaptainsQuarters_Name(), [
    ...
    friendlyShipLibrary() {
        return this.place3(Places.friendlyShipLibrary_Name(), [
            ...
            ].join(""), this.scripts.placeFriendlyShipLibrary_UseConsole.name).commandAdd(Command.fromTextsAndScriptExecuteName(["type", "enter"], this.scripts.placeFriendlyShipLibrary_Type.name)),
            ...
            ].join("")).commandAdd(Command.fromTextsAndScriptExecuteName(["hide under table"], this.scripts.placeFriendlyShipLibrary_HideUnderTable.name)).scriptUpdateForTurnSet(Script.fromName(this.scripts.placeFriendlyShip_CheckIfPlayerIsStillHidden.name)),
    ...
    friendlyShipMessHall() {
        return this.place3(Places.friendlyShipMessHall_Name(), [
            ...
            ].join("")).commandAdd(Command.fromTextsAndScriptExecuteName(["hide behind counter"], this.scripts.placeFriendlyShipMessHall_HideBehindCounter.name)).scriptUpdateForTurnSet(Script.fromName(this.scripts.placeFriendlyShip_CheckIfPlayerIsStillHidden.name))
        ]);
    }
    ...
    friendlyShipOfficersQuartersAntechamber() {
        return this.place3(Places.friendlyShipOfficersQuartersAntechamber_Name(), [
            ...
            this.portal(["corridor", "hall", "out", "outside"], Places.friendlyShipUpperDeckHallAmidships_Name()),
            ...
            this.emplacement(["plant", "artificial plant", "bush", "planter"]).descriptionWhenExaminedSet([
            ...
            ].join("")).commandAdd(Command.fromTextsAndScriptExecute([
                "hide behind plant",
                "hide behind artificial plant",
                "hide behind bush"
            ], Script.fromName(this.scripts.placeFriendlyShipOfficersQuartersAntechamber_HideBehindPlant.name))).scriptUpdateForTurnSet(Script.fromName(this.scripts.placeFriendlyShip_CheckIfPlayerIsStillHidden.name))
        ]);
    }
    static friendlyShipOfficersQuartersAntechamber_Name() {
        return "Pax Aeterna - Officer's Quarters Antechamber";
    }
    friendlyShipScienceLaboratory() {
        return this.place3(Places.friendlyShipScienceLaboratory_Name(), [
            ...
            this.portal(["hall", "corridor", "door"], Places.friendlyShipUpperDeckHallAft_Name()),
            this.emplacement(["body"]).commandAdd(Command.fromTextsAndScriptExecuteName(["search body"], this.scripts.emplacementBodyEmptySearch.name))
        ]);
    }
    static friendlyShipScienceLaboratory_Name() {
    ...
    friendlyShipUpperDeckHallAft() {
        return this.place3(Places.friendlyShipUpperDeckHallAft_Name(), [
            ...
            this.portal(["science laboratory", "lab", "laboratory", "lab", "door"], Places.friendlyShipScienceLaboratory_Name()),
            this.emplacement(["body"]).commandAdd(Command.fromTextsAndScriptExecuteName(["search body"], this.scripts.emplacementBodyEmptySearch.name))
        ]);
    }
    ...
    friendlyShipUpperDeckHallAmidships() {
        return this.place3(Places.friendlyShipUpperDeckHallAmidships_Name(), [
            ...
            this.portal(["officers' quarters", "quarters", "suite", "door"], Places.friendlyShipOfficersQuartersAntechamber_Name()),
            this.emplacement(["body"]).commandAdd(Command.fromTextsAndScriptExecuteName(["search body"], this.scripts.emplacementBodyEmptySearch.name))
        ]);
    }
    ...
    friendlyShipUpperDeckHallForward() {
        return this.place3(Places.friendlyShipUpperDeckHallForward_Name(), [
            ...
            this.portal(["bridge", "bridge door", "forward"], Places.friendlyShipBridge_Name()),
            this.portal(["captain's quarters", "quarters"], Places.friendlyShipCaptainsQuarters_Name()),
            this.emplacement(["body"]).commandAdd(Command.fromTextsAndScriptExecuteName(["search body"], this.scripts.emplacementBodyEmptySearch.name))
        ]);
    }
    ...
    enemyShipAirlockAntechamber() {
        return this.place3(Places.enemyShipAirlockAntechamber_Name(), [
            ...
            this.emplacement(["trunk", "chest", "box", "case"]).descriptionAsPartOfPlaceSet([
            ...
            this.emplacement(["vent"]).descriptionWhenExaminedSet([
    ...
    enemyShipArmory() {
        return this.place3(Places.enemyShipArmory_Name(), [
            ...
            this.portal(["arch"], Places.enemyShipStellarJuvenatorChamberCatwalk_Name()),
            Agent.fromNames(["robot", "heavily-armed robot", "guard robot"]).descriptionAsPartOfPlaceSet([
    ...
    enemyShipLaundry() {
        return this.place3(Places.enemyShipLaundry_Name(), [
            ...
            this.portal(["vent_portal"], Places.enemyShipVentilationShaft2_Name()).hide().lock(), // Never used.  Included to satisfy connectivity check.
    ...
    enemyShipLowerDeckHall1() {
        return this.place3(Places.enemyShipLowerDeckHall1_Name(), [
            ...
            this.portal(["hall", "hallway", "corridor", "bend"], Places.enemyShipLowerDeckHall2_Name()),
        ]);
    }
    static enemyShipLowerDeckHall1_Name() {
        return "Venipositor - Lower Deck - Halls - Outside Airlock Antechamber";
    }
    enemyShipLowerDeckHall2() {
        return this.place3(Places.enemyShipLowerDeckHall2_Name(), [
            "This is a hallway somwhere on a lower deck of the Venipositor.  ",
            ...
            this.portal(["elevator"], Places.enemyShipUpperDeckHall1_Name()),
            this.portal(["hall", "hallway", "corridor", "bend"], Places.enemyShipLowerDeckHall1_Name())
        ]);
    }
    static enemyShipLowerDeckHall2_Name() {
        return "Venipositor - Lower Deck - Halls II: EVB: Elevator v. Bend";
    }
    enemyShipLowerDeckHall3() {
        return this.place3(Places.enemyShipLowerDeckHall3_Name(), [
            ...
            this.portal(["arch"], Places.enemyShipStellarJuvenatorChamber_Name()),
            this.portal(["elevator"], Places.enemyShipUpperDeckHall2_Name()),
            this.portal(["hall", "hallway", "corridor"], Places.enemyShipLowerDeckHall4_Name())
        ]);
    }
    static enemyShipLowerDeckHall3_Name() {
        return "Venipositor - Lower Deck - Halls IV: Operation Trapezoidal Arch";
    }
    enemyShipLowerDeckHall4() {
        return this.place3(Places.enemyShipLowerDeckHall4_Name(), [
            ...
            this.portal(["elevator"], Places.enemyShipUpperDeckHall5_Name()),
            this.portal(["hall", "hallway", "corridor"], Places.enemyShipLowerDeckHall3_Name())
        ]);
    }
    static enemyShipLowerDeckHall4_Name() {
    ...
    enemyShipFighterBay() {
        return this.place3(Places.enemyShipFighterBay_Name(), [
            ...
            this.portal(["elevator"], Places.enemyShipUpperDeckHall2_Name()),
            this.emplacement2(["fighter", "ship"], [
    ...
    static enemyShipFighterBay_Name() {
    ...
    enemyShipStellarJuvenatorChamber() {
        return this.place3(Places.enemyShipStellarJuvenatorChamber_Name(), [
            ...
            this.portal(["arch"], Places.enemyShipLowerDeckHall3_Name())
        ]);
    }
    ...
    enemyShipStellarJuvenatorChamberCatwalk() {
        return this.place3(Places.enemyShipStellarJuvenatorChamberCatwalk_Name(), [
            ...
            this.portal(["armory"], Places.enemyShipArmory_Name()),
            this.portal(["hall", "hallway", "corridor"], Places.enemyShipUpperDeckHall6_Name()),
        ]);
    }
    static enemyShipStellarJuvenatorChamberCatwalk_Name() {
        return "Venipositor - Stellar Juvenator Chamber - Catwalk";
    }
    enemyShipUpperDeckHall1() {
        return this.place3(Places.enemyShipUpperDeckHall1_Name(), [
            ...
            this.portal(["hall", "hallway", "corridor"], Places.enemyShipUpperDeckHall2_Name()),
            this.portal(["door"], Places.enemyShipUpperDeckHall3_Name())
        ]);
    }
    static enemyShipUpperDeckHall1_Name() {
        return "Venipositor - Upper Deck - Halls III: The Upper Deckening";
    }
    enemyShipUpperDeckHall2() {
        return this.place3(Places.enemyShipUpperDeckHall2_Name(), [
            ...
            this.portal(["left elevator", "left elevator door", "door"], Places.enemyShipLowerDeckHall3_Name()),
            this.portal(["right elevator", "right elevator door", "door"], Places.enemyShipFighterBay_Name()),
            this.portal(["laundry", "laundry room", "laundry door", "door"], Places.enemyShipLaundry_Name()),
            this.portal(["hall door", "unlabelled door", "door"], Places.enemyShipUpperDeckHall4_Name()),
            this.portal(["hall", "hallway", "corridor", "shadows", "shadowy stretch of hall"], Places.enemyShipUpperDeckHall1_Name()),
        ]);
    }
    static enemyShipUpperDeckHall2_Name() {
        return "Venipositor - Upper Deck - Halls III: The Upper Deckening II: Elevator Fiesta";
    }
    enemyShipUpperDeckHall3() {
        return this.place3(Places.enemyShipUpperDeckHall3_Name(), [
            ...
            this.portal(["hall", "hallway", "corridor"], Places.enemyShipUpperDeckHall4_Name()),
            this.portal(["door"], Places.enemyShipUpperDeckHall1_Name())
        ]);
    }
    static enemyShipUpperDeckHall3_Name() {
        return "Venipositor - Upper Deck - Halls III: The Upper Deckening III: Worst One Yet";
    }
    enemyShipUpperDeckHall4() {
        return this.place3(Places.enemyShipUpperDeckHall4_Name(), [
            ...
            this.portal(["door"], Places.enemyShipUpperDeckHall2_Name()),
            this.portal(["hall", "hallway", "corridor"], Places.enemyShipUpperDeckHall3_Name()),
        ]);
    }
    static enemyShipUpperDeckHall4_Name() {
        return "Venipositor - Upper Deck - Halls III: The Upper Deckening IV: Guarded Passage";
    }
    enemyShipUpperDeckHall5() {
        return this.place3(Places.enemyShipUpperDeckHall5_Name(), [
            ...
            this.portal(["door"], Places.enemyShipLowerDeckHall4_Name()),
            this.portal(["hall", "hallway", "corridor", "darkness"], Places.enemyShipUpperDeckHall6_Name())
        ]);
    }
    static enemyShipUpperDeckHall5_Name() {
        return "Venipositor - Upper Deck - Halls III: The Upper Deckening V: Hellway";
    }
    enemyShipUpperDeckHall6() {
        return this.place3(Places.enemyShipUpperDeckHall6_Name(), [
            ...
            this.portal(["arch"], Places.enemyShipStellarJuvenatorChamberCatwalk_Name()),
            this.portal(["hall", "hallway", "corridor", "darkness"], Places.enemyShipUpperDeckHall5_Name())
        ]);
    }
    static enemyShipUpperDeckHall6_Name() {
    ...
    enemyShipVentilationShaft3() {
        return this.place3(Places.enemyShipVentilationShaft3_Name(), [
    ...
    enemyShipVentilationShaft4() {
        return this.place3(Places.enemyShipVentilationShaft4_Name(), [
            "This is a featureless stretch of ventilation shaft on the Venipositor.",
...
class Scripts {
    ...
    emplacementCaptainsBodyKeycardSearch(u, w, place, command, target) {
        var message;
        message =
        ...
        var emplacementBody = place.emplacements.find(x => x.names.indexOf("captain") >= 0);
    ...
    placeFriendlyShip_CheckIfPlayerIsStillHidden(u, w, p, c) {
        var stateNamePlayerIsHidden = "PlayerIsHidden";
        var agentPlayer = w.agentPlayer;
        var playerState = agentPlayer.stateGroup;
        var playerWasHiding = playerState.stateWithNameGetValue(stateNamePlayerIsHidden);
        if (playerWasHiding) {
            var commandText = c.text();
            var commandIsTooActiveToHide = (commandText.startsWith("look") == false
    ...
    placeFriendlyShipEscapePod_PressAutonavButton(u, w, p, c) {
        ...
        if (safetyBeltWasWorn == false) {
            ...
            p.portalByName("door").placeDestinationNameSet(Places.planetDesertCrashSite_Name());
        }
        u.messageEnqueue(message);
    }
    ...
    placeFriendlyShipLibrary_HideUnderTable(u, w, p, c) {
        u.messageEnqueue([
    ...
    placeFriendlyShipMessHall_HideBehindCounter(u, w, p, c) {
        u.messageEnqueue([
    ...
    placeFriendlyShipOfficersQuartersAntechamber_HideBehindPlant(u, w, p, c) {
        u.messageEnqueue([
    ...
    placePlanetSettlementBarFront_RefuseToSellSkimmer(u, w, p, c) {
        var emplacementSkimmerEnthusiast = p.emplacementByName("skimmer enthusiast");
        var stateName = "OffersToBuySkimmerRefusedSoFar";
        var stateGroup = emplacementSkimmerEnthusiast.stateGroup;
        var offersToBuySkimmerRefusedSoFar = parseInt(stateGroup.stateWithNameGetValue(stateName));
        offersToBuySkimmerRefusedSoFar++;
        stateGroup.stateWithNameSetToValue(stateName, offersToBuySkimmerRefusedSoFar);
    }
    placePlanetSettlementBarFront_SellSkimmer(u, w, p, c) {
        ...
        var itemsToTradeForSkimmerAsString = itemsToTradeForSkimmer.map(x => x.nameAndQuantity()).join(",");
        var message = [
    ...
    placePlanetSettlementBarFront_TalkToPerson(u, w, p, c) {
        ...
        emplacementSkimmerBuyer.commandAddFromTextsAndScriptName(["say yes", "yes", "sell skimmer", "deal"], scripts.placePlanetSettlementBarFront_SellSkimmer.name);
        emplacementSkimmerBuyer.commandAddFromTextsAndScriptName(["say no", "no", "refuse", "no deal"], scripts.placePlanetSettlementBarFront_RefuseToSellSkimmer.name);
        u.messageEnqueue(message);
    }
    ...
    regionFriendlyShip_UpdateForTurn(u, w, p, c) {
        ...
        if (player.hidden()) {
            ...
            var doesPlayerRemainHidden = commandText == "wait"
    ...
    regionFriendlyShip_AgentEnemyUpdateForTurn(u, w, p, c) {
        ...
        var agentPlayer = w.agentPlayer;
        var stateNamePlaceOccupiedOnPreviousTurnName = "PlaceOccupiedOnPreviousTurnName";
        var placeOccupiedByPlayerOnPreviousTurnName = agentPlayer.stateWithNameGetValue(stateNamePlaceOccupiedOnPreviousTurnName);
        var placeOccupiedByPlayer = w.placeCurrent();
        agentPlayer.stateWithNameSetToValue(stateNamePlaceOccupiedOnPreviousTurnName, placeOccupiedByPlayer.name);
        var playerHasJustMoved = (placeOccupiedByPlayer.name != placeOccupiedByPlayerOnPreviousTurnName);
        var playerIsVisible = agentPlayer.visible();
        if (placeOccupiedByEnemy == placeOccupiedByPlayer) {
            message = Scripts.Instance().regionFriendlyShip_AgentEnemyUpdateForTurn_2(u, w, p, agentEnemy, playerIsVisible, playerHasJustMoved);
        }
        else {
            message = Scripts.Instance().regionFriendlyShip_AgentEnemyUpdateForTurn_3(u, w, p, agentEnemy, playerIsVisible, playerHasJustMoved);
        }
        if (message != null) {
            u.messageEnqueue(message);
        }
    }
    regionFriendlyShip_AgentEnemyUpdateForTurn_2(u, w, placeOccupiedByEnemy, agentEnemy, playerIsVisible, playerHasJustMoved) {
        var message;
        if (playerIsVisible) {
    ...
    regionFriendlyShip_AgentEnemyUpdateForTurn_3(u, w, placeOccupiedByEnemy, agentEnemy, playerIsVisible, playerHasJustMoved) {
        var message;
        var stateNamePlaceOnPatrolRouteIndex = "PlaceOnPatrolRouteIndex";
        var placeOnPatrolRouteIndex = agentEnemy.stateGroup.stateWithNameGetValue(stateNamePlaceOnPatrolRouteIndex);
        ...
        var patrolRouteIsComplete = placeOnPatrolRouteIndex == null
            || placeOnPatrolRouteIndex >= placesOnPatrolRouteNames.length;
        if (patrolRouteIsComplete) {
            placeOnPatrolRouteIndex = 1;
        }
        var placeForEnemyToGoToNextName = placesOnPatrolRouteNames[placeOnPatrolRouteIndex];
        var placeForEnemyToGoToNext = w.placeByName(placeForEnemyToGoToNextName);
        var placeOccupiedByPlayer = w.placeCurrent();
        var enemyIsAboutToEnterPlaceOccupiedByPlayer = (placeForEnemyToGoToNext == placeOccupiedByPlayer);
        // Only move into player's room
        // if the player hasn't just moved there,
        // because otherwise the player gets no warning.
        var enemyShouldMove = (enemyIsAboutToEnterPlaceOccupiedByPlayer == false)
            || (playerHasJustMoved == false);
        if (enemyShouldMove) {
            placeOnPatrolRouteIndex++;
            agentEnemy.stateGroup.stateWithNameSetToValue(stateNamePlaceOnPatrolRouteIndex, placeOnPatrolRouteIndex);
            var portalForEnemyToGoThroughNext = placeOccupiedByEnemy.portalByPlaceDestinationName(placeForEnemyToGoToNextName);
            agentEnemy.goThroughPortal(portalForEnemyToGoThroughNext, w);
        }
        placeOccupiedByEnemy = agentEnemy.place(w);
        var enemyIsInPlaceAdjacentToPlaceOccupiedByPlayer = placeOccupiedByEnemy.adjacentTo(placeOccupiedByPlayer);
        if (placeOccupiedByEnemy == placeOccupiedByPlayer) {
            message = Scripts.Instance().regionFriendlyShip_AgentEnemyUpdateForTurn_2(u, w, placeOccupiedByEnemy, agentEnemy, playerIsVisible, playerHasJustMoved);
        }
        else if (enemyIsInPlaceAdjacentToPlaceOccupiedByPlayer) {
            var portalEnemyWillArriveThrough = placeOccupiedByPlayer.portalByPlaceDestinationName(placeOccupiedByEnemy.name);
            var portalName = portalEnemyWillArriveThrough.name();
            var isDefiniteArticleNeeded = portalName != "forward"
                && portalName != "aft"
                && portalName != "outside";
            message =
                [
