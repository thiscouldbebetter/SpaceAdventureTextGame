...
class Items
{
	...
	gadget(): Item
	{
		...
		(
			...
			"This is a strange blinking gadget you found in a closet.  "
	...
	spaceSuit(): Item
	{
		return Item.fromNamesDescriptionAndScriptGetName
		(
...
class Regions
{
	...
	constructor()
	{
		...
		[
			// Friendly Ship.
			Region.fromNameScriptUpdateForTurnNameAndPlaces
			(
				"Pax Aeterna",
...
class Scripts
{
	...
	): void
	{
		var playerIsWearingSpaceSuit =
			(w.player.itemByName("space suit") != null);
